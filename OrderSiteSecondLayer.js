...
async function checkInfo(){
  ...
  async function checkDuplicate(id1,id2,errorMessage) {
  ...
  await Promise.all([
      ...
      checkDuplicate('phone1','phone2',"אנא שים לב הכנסת פעמיים את אותו מספר טלפון"),
      checkDuplicate('email1','email2',"אנא שים לב הכנסת פעמיים את אותו המייל")
  ]);
